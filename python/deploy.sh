...
if ! aws lambda get-function --function-name $FNAME 1> /dev/null 2>&1;  then
    ...
    aws lambda create-function      --function-name $FNAME --zip-file fileb://./$ZIPFILE --runtime python3.6 --role arn:aws:iam::854014537498:role/lambda_basic_execution --handler lambda_handler.call
else
